...
CREATE TABLE AssStatoPraticheUtenti (
  ...
  PRIMARY KEY (idStato),
  FOREIGN KEY (idStato) REFERENCES StatoPratiche(id) ON DELETE NO ACTION ON UPDATE CASCADE,
...
CREATE TABLE AssStatoPraticheIntegrazioni (
  ...
  PRIMARY KEY (idStato),
  FOREIGN KEY (idStato) REFERENCES StatoPratiche(id) ON DELETE NO ACTION ON UPDATE CASCADE,
  FOREIGN KEY (idInteg) REFERENCES Integrazioni(id) ON DELETE NO ACTION ON UPDATE CASCADE
);

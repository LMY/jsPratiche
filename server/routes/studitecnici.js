...
router.post('/', function(req, res, next) {
	sql.pool.query('INSERT INTO '+sql.tables.StudiTecnici+'($1,$2) VALUES ($3,$4)', ["name", "pec", req.body.name, req.body.pec], function(err, data) {
		if (err) rest.error500(res, err);
...
router.put('/:id', function(req, res, next) {
	sql.pool.query('UPDATE '+sql.tables.StudiTecnici+' SET $1 = $2, $3 = $4 WHERE $5 = $6', ["name", req.body.name, "pec", req.body.pec, "id", req.params.id], function(err, data) {
		if (err) rest.error500(res, err);
